...
Caret.prototype.text = function text(str, styleFn) {
  this.x += str.length;
  return this.jetty.text(str, styleFn);
};

Caret.prototype.erase = function erase(n, styleFn) {
  this.x += n;
  return this.jetty.erase(n, styleFn);
};
...
Caret.prototype.move = function move() {
  return this.jetty.moveTo(Coord.add(this.box.position, this.position).toArray());
};

Caret.prototype.clear = function clear(n) {
  return this.jetty.clear(n);
};
